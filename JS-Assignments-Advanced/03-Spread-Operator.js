...
// which stores an array of strings (author names) if there are multiple authors, or a single string (author name) if there is just one author.
...
spellWord('Javascript'); // Output: J a v a s c r i p t
